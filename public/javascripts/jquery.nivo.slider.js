...
(function($) {
    ...
    var NivoSlider = function(element, options){
        ...
        if(settings.controlNav){
            var nivoControl = $('<p class="nivo-controlNav"><span class="l"></span><span class="r"></span></p>');
			var clearControl = $('<div class="clear"></div>');
			
		
//			nivoControl.before("<center>");
            slider.after(nivoControl);
		    slider.after(clearControl);
			$('.nivo-controlNav').wrap("<center></center>");
//			$('.nivo-controlNav').after("</center>");
//			nivoControl.after("</center>");
...
/*				if($('.nivo-caption').css('display') == 'block'){
					$('.nivo-caption p').fadeIn(settings.animSpeed, function(){
						$(this).html(title);
...
//				$('.nivo-caption').fadeOut(settings.animSpeed);
			}
