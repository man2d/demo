...
# If you override the class here, please ensure to override it in your formtastic_changes.css stylesheet as well
 Formtastic::SemanticFormBuilder.default_hint_class = "info"
# Formtastic::SemanticFormBuilder.default_inline_error_class = "inline-errors"
# Formtastic::SemanticFormBuilder.defa  ult_error_list_class = "errors"
...
#Formtastic::SemanticFormBuilder.inline_order = [:input, :hints, :errors, :examples]
...
#Formtastic::SemanticFormBuilder.custom_inline_order[:ckeditor] = [:hints, :input, :errors]
